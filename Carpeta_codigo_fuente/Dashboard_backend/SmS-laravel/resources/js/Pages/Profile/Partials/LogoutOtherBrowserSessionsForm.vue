<template>
    <jet-action-section>
        ...
        <template #description>
            Administre y cierre sesión en sus sesiones activas en otros
        ...
        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                ...
                puede no ser exhaustiva. Si cree que su cuenta se ha visto
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    ...
                    en sus otras sesiones de navegador en todos sus
                    dispositivos.
                    <div class="mt-4">
                        <jet-input
                            type="password"
